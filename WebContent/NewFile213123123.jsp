...
// 		out.print("<td style>  <a href='ProjectInfo.jsp?PJNo="+ rs.getString("DocNo") +"'>" + "<span>" + rs.getString("DocNm") + "</span>" + " </a></td>");
		out.print("<td>  <a href='#layer2' class = 'btn-example'>" + "<span>" + rs.getString("DocNm") + "</span>" + " </a></td>");
